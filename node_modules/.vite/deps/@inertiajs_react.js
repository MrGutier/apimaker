import {
  axios_default
} from "./chunk-ZLLPPDXX.js";
import {
  require_cjs,
  require_lib
} from "./chunk-CJE725IQ.js";
import {
  require_lodash
} from "./chunk-PGTMKWAN.js";
import "./chunk-RM2XN66D.js";
import {
  require_react
...
function k(t, e, i, n = "brackets") {
  ...
  return t === "get" && Object.keys(i).length && (c.search = O.stringify((0, import_deepmerge2.default)(O.parse(c.search, { ignoreQueryPrefix: true }), i), { encodeValuesOnly: true, arrayFormat: n }), i = {}), [[s ? `${c.protocol}//${c.host}` : "", l ? c.pathname : "", h ? c.pathname.substring(1) : "", g ? c.search : "", f ? c.hash : ""].join(""), i];
}
function w(t) {
...
var C = class {
  ...
  visit(e, { method: i = "get", data: n = {}, replace: s = false, preserveScroll: l = false, preserveState: h = false, only: g = [], except: f = [], headers: c = {}, errorBag: o = "", forceFormData: v = false, onCancelToken: T = () => {
    ...
    let M = !!(g.length || f.length);
    axios_default({ method: i, url: w(S).href, data: i === "get" ? {} : n, params: i === "get" ? n : {}, signal: this.activeVisit.cancelToken.signal, headers: { ...c, Accept: "text/html, application/xhtml+xml", "X-Requested-With": "XMLHttpRequest", "X-Inertia": true, ...M ? { "X-Inertia-Partial-Component": this.page.component } : {}, ...g.length ? { "X-Inertia-Partial-Data": g.join(",") } : {}, ...f.length ? { "X-Inertia-Partial-Except": f.join(",") } : {}, ...o && o.length ? { "X-Inertia-Error-Bag": o } : {}, ...this.page.version ? { "X-Inertia-Version": this.page.version } : {} }, onUploadProgress: (r) => {
      ...
      let a = r.data;
      M && a.component === this.page.component && (a.props = (0, import_deepmerge.default)(this.page.props, a.props, { arrayMerge: (he, ne2) => ne2 })), l = this.resolvePreserveOption(l, a), h = this.resolvePreserveOption(h, a), h && ((_a = window.history.state) == null ? void 0 : _a.rememberedState) && a.component === this.page.component && (a.rememberedState = window.history.state.rememberedState);
      let E2 = S, V2 = b(a.url);
...
function O2({ children: d, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: S }) {
  ...
  if ((0, import_react5.useEffect)(() => {
    De.init({ initialPage: c, resolveComponent: p, swapComponent: async ({ component: l, page: e, preserveState: i }) => {
      P((o) => ({ component: l, page: e, key: i ? o.key : Date.now() }));
    } }), De.on("navigate", () => u2.forceUpdate());
  }, []), !f.component)
    return (0, import_react5.createElement)(A2.Provider, { value: u2 }, (0, import_react5.createElement)(E.Provider, { value: f.page }, null));
